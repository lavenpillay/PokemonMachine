...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (34, 9, 'Badly poisons the target, inflicting more damage every turn.', '[Badly poisons]{mechanic:badly-poisons} the target.  Never misses when used by a []{type:poison}-type Pokémon.');
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (342, 9, 'Raises the Attack and Special Attack of all []{type:grass} Pokémon in battle.', 'Raises the Attack and Special Attack of all []{type:grass} Pokémon in battle.');
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (343, 9, 'Covers the opposing field, lowering opponents'' Speed by one stage upon switching in.', 'Shoots a web over the opponents'' side of the field, which lowers the Speed of any opposing Pokémon that enters the field by one stage.
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (347, 9, 'Changes all []{type:normal} moves to []{type:electric} moves for the rest of the turn.', 'Changes all Pokémon''s []{type:normal} moves to []{type:electric} moves for the rest of the turn.');
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (354, 9, 'Protects all friendly Pokémon from non-damaging moves.', 'Protects all friendly Pokémon from non-damaging moves for the rest of the turn.

Unlike other blocking moves, this move may be used consecutively without its chance of success falling.');
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (355, 9, 'Raises the Defense of all []{type:grass} Pokémon in battle', 'Raises the Defense of all []{type:grass} Pokémon in battle.');
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (61, 10, 'Sníží protivníkovi Obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (66, 10, 'Na p?t kol sníží zran?ní z fyzických útok? o 50%.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (73, 10, 'Má $effect_chance% šanci snížit protivníkovu Speciální obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (186, 10, 'Zp?sobí dvojnásobné zran?ní, pokud uživatel už byl toto kolo zran?n.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (205, 10, 'Po zran?ní protivníka sníží uživatel?v Speciální útok o dva stupn?.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (116, 10, 'Na p?t kol zp?sobí píse?nou bou?i.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (4, 10, 'Vylé?í uživatele o polovinu zp?sobeného zran?ní.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (101, 10, 'Sníží PP protivníkova posledn? použitého útoku o 4.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (106, 10, 'Vezme protivníkovi drženou v?c.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (28, 10, 'Zaúto?í každé kolo, 2-3×; poté zmate uživatele.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (35, 10, 'Rozsype peníze v hodnot? 5× úrovn? uživatele.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (125, 10, 'Po p?t kol chrání pokémony uživatelov? stran? proti zm?nám stavu a zmatení.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (40, 10, 'První kolo se nabíjí, zaúto?í až v druhém.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (148, 10, 'Normáln? zra?uje; zasáhne i pokémony pod zemí.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (59, 10, 'Sníží protivník?v Útok o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (18, 10, 'Vždy se trefí.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (25, 10, 'Sníží protivníkovu Mrštnost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (10006, 10, 'Na p?t kol zatemní oblohu.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (133, 10, 'Uzdraví uživatele za 1/2 max. HP. Ovlivn?no po?asím.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (138, 10, 'Na p?t kol zp?sobí, že slunce svítí jasn?ji než normáln?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (49, 10, 'Zraní uživatele za 1/4 zp?sobeného zran?ní.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (323, 10, 'Zvýší uživatel?v Útok, Obranu a P?esnost útok po jednom stupni.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (70, 10, 'Má $effect_chance% šanci snížit protivníkovu Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (157, 10, 'Zvýší uživatelovu Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (328, 10, 'Zvýší uživatel?v Útok a Speciální útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (169, 10, 'Sníží protivník?v Útok a Speciální útok o dva stupn?. Uživatel omdlí.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (63, 10, 'Sníží protivníkovu Speciální obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (313, 10, 'Zvýší uživateli Útok o jednu a Rychlost o dv? úrovn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (104, 10, 'Normáln? zra?uje, bez vedlejších ú?ink?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (207, 10, 'Zvýší uživatelovu Obranu a Speciální obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (212, 10, 'Zvýší uživatel?v Speciální útok a Speciální obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (53, 10, 'Zvýší uživateli Rychlost o dv? úrovn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (231, 10, 'Má dvojnásobnou sílu, pokud protivník už toto kolo úto?il.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (248, 10, 'Zm?ní protivníkovu schopnost na Insomnii.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (82, 10, 'Pokud je uživatel po použití tohoto útoku zasažen, zvýší se mu Útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (11, 10, 'Zvýší uživatel?v Útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (110, 10, 'Duchové ob?tují 1/2 max. HP na kletbu, která protivníka zra?uje každé kolo. Ostatním sníží Rychlost a zvýší Útok a Obranu.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (197, 10, 'Siln?jší proti t?žším protivník?m. Maximální síla je 120.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (136, 10, 'Síla a typ závisí na uživatelových genech. Síla m?že být od 30 do 70.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (160, 10, 'Používá se po n?kolik kol stále dokola. Mezitím pokémoni nemohou usnout.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (1, 10, 'Normáln? zra?uje, bez vedlejších ú?ink?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (304, 10, 'Ignoruje zm?ny protivníkových stat?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (145, 10, 'Zp?sobí dvakrát více speciálního zran?ní, než kolik utržil uživatel když byl naposledy zasažen.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (258, 10, 'Normáln? zra?uje. Zasáhne i protivníky pod vodou.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (20, 10, 'Sníží protivníkovu Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (117, 10, 'Uživateli toto kolo z?stane aspo? 1 HP.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (39, 10, 'Vy?adí protivníka na jeden zásah.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (122, 10, 'Tím siln?jší, ?ím je uživatel ocho?en?jší. Maximální síla je 102.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (51, 10, 'Zvýší uživatel?v Útok o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (80, 10, 'P?evede 1/4 uživatelova HP do figurky, která ho chrání p?ed dalším zran?ním a zm?nami stavu, dokud se nerozbije.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (183, 10, 'Po zran?ní sníží uživateli Útok a Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (29, 10, 'Okamžit? ukon?í zápas s divokým pokémonem. Trenéry donutí vym?nit pokémona.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (303, 10, 'Síla se zvýší o 100% za každé po sob? jdoucí použití pokémonem na uživatelov? stran?, až do max. síly 200.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (34, 10, 'Vážn? otráví protivníka; jed ubere každé kolo více zran?ní.', '[T?žce otráví]{mechanic:bad-poison} protivníka.');
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (219, 10, 'Sníží uživatelovu Rychlost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (332, 10, 'První kolo se nabíjí, zaúto?í až ve druhém. Má $effect_chance% šanci paralyzovat protivníka.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (206, 10, 'Sníží protivník?v Útok a Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (209, 10, 'Zvýší uživatel?v Útok a Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (317, 10, 'Zvýší uživatel?v Útok a Speciální útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (79, 10, 'Vždy se trefí.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (322, 10, 'Zvýší uživatel?v Speciální útok o t?i stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (329, 10, 'Zvýší uživatelovu Obranu o t?i stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (120, 10, 'Kdy je tento útok používán stále dokola, jeho síla se prvních 5 kol vždy zdvojnásobí; poté z?stane 32× siln?jší.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (69, 10, 'Má $effect_chance% šanci snížit protivník?v Útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (74, 10, 'Má $effect_chance% šanci snížit protivníkovu P?esnost o jeden stupe?.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (262, 10, 'Po 2-5 kol nedovolí protivníkovi opustit zápas a ud?luje mu zran?ní ve výši 1/16 max. HP za kolo.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (93, 10, 'Má $effect_chance% šanci, že se protivník zalekne. Povede se pouze p?i spánku.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (98, 10, 'Použije náhodný z uživatelových ostatních útok?. Povede se pouze ze spánku.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (213, 10, 'Zvýší uživatel? Útok a Rychlost o jeden stupe?.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (152, 10, 'První kolo se nabíjí, zaúto?í až v druhém.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (171, 10, 'Pokud uživatel p?ed zaúto?ením utrží zran?ní, tento útok se nepovede.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (14, 10, 'Zvýší uživatel?v Speciální útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (17, 10, 'Zvýší uživatelovu Mrštnost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (284, 10, 'Zp?sobí dvojnásobné zran?ní, pokud je protivník otávený.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (291, 10, 'Zvýší uživatel?v Speciální útok, Speciální obranu a Rychlost po jednom stupni.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (38, 10, 'Uživatel na dv? kola usne, ?ímž se úpln? vylé?í.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (296, 10, 'Nomáln? zra?uje. Zvýší uživatelovu Rychlost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (137, 10, 'Na p?t kol zp?sobí déš?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (315, 10, 'Zni?í protivníkovi držené ovoce.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (182, 10, 'Nedovolí uživateli opustit zápas a lé?í ho za 1/16 max. HP za kolo.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (36, 10, 'Na p?t kol sníží zran?ní ze speciálních útok? o 50%.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (55, 10, 'Zvýší uživatelovu Speciální obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (60, 10, 'Sníží protivníkovu Obranu o dva stupn?.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (72, 10, 'Má $effect_chance% šanci snížit protivník?v Speciální útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (175, 10, 'Zvýší uživatelovu Speciální obranu o jeden stupe?. Jeho Elektrické útoky mají v p?íštím kole dvojnásobnou sílu.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (21, 10, 'Sníží protivníkovu Rychlost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (165, 10, 'Na p?t kol p?ivolá padající kroupy.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (170, 10, 'P?i popálení, paralýze nebo otrav? má dvojnásobnou sílu.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (189, 10, 'P?inutí protivníka pustit drženou v?c.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (309, 10, 'Zvýší uživatel?v Útok, Obranu a Rychlost o dva stupn?. Sníží mu Obranu a Speciální obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (314, 10, 'Ukon?í zápas s divokým pokémonem. Trenéry donutí vym?nit pokémona.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (267, 10, 'Zra?uje protivníkovy pokémony, když jsou vysláni do zápasu.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (119, 10, 'Zvýší protivník?v Útok o dva stupn?, a zmate ho.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (124, 10, 'Tím siln?jší, ?ím je uživatel mén? ocho?ený. Maximální síla je 102.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (85, 10, 'Zasadí do protivníka semínka, která mu každé kolo ubírají HP a lé?í uživatele.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (90, 10, 'Zp?sobí dvakrát více fyzického zran?ní, než kolik utržil uživatel když byl naposledy zasažen.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (257, 10, 'Uživatel se zahrabe pod zem, kde se vyhýbá všem útok?m. V následujícím kole zaúto?í.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (12, 10, 'Zvýší uživatelovu Obranu o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (19, 10, 'Sníží protivník?v Útok o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (278, 10, 'Zvýší uživatel?v Útok a P?esnost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (109, 10, 'Zvýší uživatelovu Mrštnost obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (24, 10, 'Sníží protivníkovu P?esnost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (121, 10, 'Protivník se zamiluje do uživatele. Poté má 50% šanci na n?j nezaúto?it.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (234, 10, 'Hodí na protivníka drženou v?c; síla závisí na druhu v?ci.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (9, 10, 'Funguje jen na spící protivníky. Vylé?í uživatele o polovinu zp?sobeného zran?ní.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (10004, 10, 'Sníží protivníkovu Mrštnost o dva stupn?.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (30, 10, 'Zaúto?í 2-5× za sebou.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (54, 10, 'Zvýší uživatel?v Speciální útok o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (141, 10, 'Má $effect_chance% šanci uživateli zvýšit všechny staty o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (146, 10, 'Zvýší uživateli Obranu o jeden stupe?. Zaúto?í až v následujícím kole.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (331, 10, 'Sníží protivníkovi Obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (174, 10, 'Použije útok závislý na okolním prost?edí.', null);
...
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (266, 10, 'Sníží protivník?v Speciální útok o dva stupn?, pokud je opa?ného pohlaví.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (198, 10, 'Má $effect_chance% šanci zp?sobit zm?nu stavu. Jakou, to závisí na okolním prost?edí.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (285, 10, 'Zvýší uživatelovu Rychlost o dva stupn? a sníží mu hmotnost na polovinu.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (297, 10, 'Sníží protivníkovu Speciální obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (52, 10, 'Zvýší uživatelovu Obranu o dva stupn?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (71, 10, 'Má $effect_chance% šanci snížit protivníkovu Rychlost o jeden stupe?.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (83, 10, 'Zkopíruje posledn? použitý protivník?v útok.', null);
INSERT INTO [move_effect_prose] ([move_effect_id], [local_language_id], [short_effect], [effect]) VALUES (88, 10, 'Ud?lí zran?ní v HP rovné uživatelovi úrovni.', 'Ud?lí zran?ní v HP rovné uživatelovi úrovni. Typové imunity platí, ale ostatní efekty typ? jsou ignorovány.');
